  ...
  return (
    <Box
      ...
      sx={{
        p: 2.5,
        borderRadius: '20px',
        border: `1px solid ${isGradient ? 'transparent' : `color-mix(in srgb, ${tokens.borderStrong} 40%, transparent)`}`,
        bgcolor: isGradient ? 'transparent' : `color-mix(in srgb, ${tokens.surface} 40%, transparent)`,
