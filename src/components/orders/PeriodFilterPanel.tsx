...
import type { PeriodPreset } from '@/types/period'
import { PERIOD_LABELS } from '@/types/period'
import type { Dayjs } from 'dayjs'

const PERIODS: PeriodPreset[] = ['day', 'weekly', 'monthly', 'year', 'custom']
...
export function PeriodFilterPanel({
  ...
  description = 'Select a period to update summary cards, reports, and the order list.',
          ...
          return (
            <Button
              ...
              sx={{
                ...
                '&:hover': { bgcolor: active ? 'primary.dark' : quickActionBtn.hoverBg },
              }}
            >
              {PERIOD_LABELS[p]}
            </Button>
